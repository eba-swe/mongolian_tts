# Mongolian language data loader: Based on https://github.com/tugstugi/pytorch-dc-tts
...
vocab = "PE абвгдеёжзийклмноөпрстуүфхцчшъыьэюя-.,!?"
...
# Convert Mongolian number to Text: 
